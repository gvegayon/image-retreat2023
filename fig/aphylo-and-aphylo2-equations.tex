...
$$
\Prcond{\aphyloObs_n}{\ann{n},\Theta}= %
	\prod_{m\in\offspring{n}}%
	\sum_{\ann{m}\in \{0, 1\}}%
	\Prcond{\ann{m}}{\ann{n}}%
	\Prcond{\aphyloObs_{m}}{\ann{m}}
$$


$$
\Prcond{\ann{m}=1}{\ann{n}} = \left\{\begin{array}{lc}%
	\mu_0,\quad\mbox{if }\ann{n} = 0 & \mbox{(Gain)}\\%
	\mu_1,\quad\mbox{if }\ann{n} = 1 & \mbox{(Loss)}%
\end{array}\right.
$$
...
$$
\Prcond{\ann{m}=1}{\ann{n},W} = \Logit{\transpose{\Theta}f(\ann{m},\ann{n},W)}
$$
}
